      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-12 space-y-8 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-slate-200 pb-5">
          <div className="space-y-1">
            <Link
              href="/admin"
              className="inline-flex items-center gap-1.5 text-xs text-slate-500 hover:text-slate-900 transition-colors uppercase font-bold tracking-wider mb-2"
            >
              <ArrowLeft className="h-3 w-3" /> Back to Dashboard
            </Link>
            <h1 className="text-2xl font-bold text-slate-900 sm:text-3xl">Manage Study Resources</h1>
            <p className="text-sm text-slate-600">Upload study materials, references, or PDFs for candidates.</p>
          </div>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            <Card className="border-slate-200 bg-white/50 backdrop-blur-md shadow-2xl sticky top-8">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="space-y-2">
                    <Label htmlFor="title" className="text-slate-700 font-semibold text-xs uppercase tracking-wider">
                      Resource Title
                    </Label>
                    <Input
                      id="title"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="description" className="text-slate-700 font-semibold text-xs uppercase tracking-wider">
                      Description
                    </Label>
                    <Textarea
                      id="description"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="file-upload" className="text-slate-700 font-semibold text-xs uppercase tracking-wider">
                      Choose File
                    </Label>
                    <Input
                      id="file-upload"
                      ...
                      required
                      className="cursor-pointer file:mr-4 file:py-1 file:px-2.5 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-slate-100 file:text-slate-900 hover:file:bg-neutral-750"
                    />
                    {fileName && (
            ...
            <Card className="border-slate-200 bg-white/50 backdrop-blur-md shadow-2xl">
              ...
              <CardContent className="space-y-4">
                {loading ? (
                  ...
                  <p className="text-xs text-slate-500 italic py-12 text-center">No study resources uploaded yet.</p>
                ) : (
                      ...
                      >
                        <div className="space-y-1 min-w-0 flex-1">
                          <div className="flex items-center gap-2">
                            <p className="font-extrabold text-sm text-slate-800 tracking-tight truncate max-w-[280px]" title={resource.title}>
                              {resource.title}
                            </p>
                        ...
                        <div className="flex items-center gap-2 justify-end sm:shrink-0">
                          <a
                            ...
                            className="inline-flex h-8 w-8 items-center justify-center rounded-md text-slate-600 hover:bg-slate-100 hover:text-slate-900 transition-colors"
                            title="View Resource"
                          >
                          ...
                          <a
                            ...
                            className="inline-flex h-8 items-center justify-center rounded-md border border-slate-200 bg-slate-50/40 px-3 text-[10px] font-extrabold uppercase text-slate-600 transition-colors hover:bg-slate-50 hover:text-slate-900"
                          >
                          ...
                          <Button
                            variant="ghost"
                            size="icon"
                            className="h-8 w-8 text-slate-500 hover:text-red-400 hover:bg-red-950/20 transition-colors"
